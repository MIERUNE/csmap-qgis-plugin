...
- Input Layer (DEM)
  ...
  - You can select data either from imported layers or from a file.
- Processing Mode
  - Main Process: Converts input DEM to CS topographical map.
  - Preview: Allows you to check color schemes after setting detailed parameters.
  - Allows you to check color schemes in a sample area after setting detailed parameters.
- Detailed Parameters
  - Parameters can be configured as needed.
- Output Layer
  - By default, it is saved as a temporary file.
  - You can save output data to a file if needed.
